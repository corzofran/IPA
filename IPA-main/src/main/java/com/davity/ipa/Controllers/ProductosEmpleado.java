...
public class ProductosEmpleado {
    ...
    @FXML
    private TableColumn<Producto, ?> columnaMarca;
    ...
    void initialize() {
        ...
        Validator<String> marcaValidator = Validator.createEmptyValidator("La clasificación es requerida");
        ...
        validationSupport.registerValidator(marca, true, marcaValidator);
    ...
    void onClickguardar(MouseEvent event) {
        ...
        Producto p = new Producto(product,quanty, clasification, mark);
 //////////////////////////////
        productos.add(p);
/////////////////////////////
    ...
    public void onClickmodificar(MouseEvent mouseEvent) {
        ...
        if(p ==null){
            ...
            try{
                ...
                String mark = this.clasificacion.getText();

                Producto pro = new Producto(product, quanty, clasification, mark);
                ...
                if(!this.productos.contains(pro)){
                    ...
                    String marcasElement = marca.getText();
                    ...
                    marca.set(positionModified, marcasElement);
                }else {
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setTitle("Error");
                    alert.setHeaderText(null);
